...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createAlbum":
		...
		return e.complexity.Mutation.CreateAlbum(childComplexity, args["bandId"].(string), args["title"].(string), args["releaseDate"].(string)), true
...
func (ec *executionContext) _Mutation_createAlbum(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateAlbum(rctx, fc.Args["bandId"].(string), fc.Args["title"].(string), fc.Args["releaseDate"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputSongInput(ctx context.Context, obj interface{}) (model.SongInput, error) {
	...
	fieldsInOrder := [...]string{"title", "duration", "albumId"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
